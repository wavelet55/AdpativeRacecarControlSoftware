...
#ifndef VIDERE_DEV_SIPNPUFFDATARECORD_H
#define VIDERE_DEV_SIPNPUFFDATARECORD_H
...
namespace videre
{
#define SIPNPUFFMAXRECORDSIZE 40


    class SipnPuffDataRecord : public DataRecorderAbstractRecord
    {
    private:

        char _recordBuf[SIPNPUFFMAXRECORDSIZE];
...
#endif //VIDERE_DEV_SIPNPUFFDATARECORD_H
