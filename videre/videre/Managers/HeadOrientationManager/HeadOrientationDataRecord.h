...
#ifndef VIDERE_DEV_HEADORIENTATIONDATARECORD_H
#define VIDERE_DEV_HEADORIENTATIONDATARECORD_H
...
namespace videre
{
#define HEADORIENTATIONMAXRECORDSIZE 64

    class HeadOrientationDataRecord : public DataRecorderAbstractRecord
    {
    private:

        char _recordBuf[HEADORIENTATIONMAXRECORDSIZE];

    public:
        std::shared_ptr<SipnPuffMessage> SipnPuffValueMsg;

    public:
        HeadOrientationDataRecord();
...
#endif //VIDERE_DEV_HEADORIENTATIONDATARECORD_H
