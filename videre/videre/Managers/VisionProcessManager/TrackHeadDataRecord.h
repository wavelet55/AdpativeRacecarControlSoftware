...
#ifndef VIDERE_DEV_TRACKHEADDATARECORD_H
#define VIDERE_DEV_TRACKHEADDATARECORD_H
...
namespace videre
{
#define TRACKHEADMAXRECORDSIZE 96


    class TrackHeadDataRecord : public DataRecorderAbstractRecord
    {
    private:

        char _recordBuf[TRACKHEADMAXRECORDSIZE];

    public:
        std::shared_ptr<TrackHeadOrientationMessage> TrackHeadOrientationMsg;
...
#endif //VIDERE_DEV_TRACKHEADDATARECORD_H
