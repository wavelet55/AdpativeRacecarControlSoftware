...
#ifndef _CUDA_EXCEPTION_H_
#define _CUDA_EXCEPTION_H_
...
class CudaException : public Std_Exception
{
    public:
    ...
    private:
        ...
        CudaException(const std::string &str);
...
#define RUNTIME_EXCEPTION( msg) \
    CudaException<std::runtime_error>::throw_it( __FILE__, __LINE__, msg)

//! Logic exception in program, e.g. an assert failed
#define LOGIC_EXCEPTION( msg) \
    CudaException<std::logic_error>::throw_it( __FILE__, __LINE__, msg)

//! Out of range exception
#define RANGE_EXCEPTION( msg) \
    CudaException<std::range_error>::throw_it( __FILE__, __LINE__, msg)
...
////////////////////////////////////////////////////////////////////////////////
template<class Std_Exception>
CudaException<Std_Exception>::CudaException() :
...
////////////////////////////////////////////////////////////////////////////////
template<class Std_Exception>
CudaException<Std_Exception>::CudaException(const std::string &s) :
    Std_Exception(s)
{ }
...
////////////////////////////////////////////////////////////////////////////////
template<class Std_Exception>
CudaException<Std_Exception>::~CudaException() throw() { }
