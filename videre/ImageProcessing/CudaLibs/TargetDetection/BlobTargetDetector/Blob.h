...
#ifndef CUDA_CBLOB_INSPECTA_INCLUDED
#define CUDA_CBLOB_INSPECTA_INCLUDED
...
*/
    ...
    public:
        ...
        //! Constructor de c?ia
        //! Copy constructor
        CBlob_cuda(const CBlob_cuda &src);
        ...
        CBlob_cuda &operator=(const CBlob_cuda &src);
        ...
        void CopyEdges(CBlob_cuda &destination) const;
        ...
        void FillBlob(cv::Mat *imatge, CvScalar color, int offsetX = 0, int offsetY = 0) const;
...
//! Interface to derive all blob operations
    ...
    public:
        ...
        virtual double operator()(const CBlob_cuda &blob) const = 0;
...
//! Class to get the area of a blob
    ...
    {
    public:
        double operator()(const CBlob_cuda &blob) const
        {
            return blob.Area();
        }
