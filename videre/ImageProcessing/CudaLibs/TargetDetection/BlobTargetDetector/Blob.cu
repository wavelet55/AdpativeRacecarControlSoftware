...
namespace CudaBlobTargetDetectorNS
{
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    CBlob_cuda::CBlob_cuda(const CBlob_cuda &src)
    {
    ...
    */
    ...
    /**
    - FUNCI? operator=
    - FUNCIONALITAT: Operador d'assignaci?- PAR�METRES:
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    CBlob_cuda &CBlob_cuda::operator=(const CBlob_cuda &src)
    {
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    void CBlob_cuda::FillBlob(cv::Mat *imatge, CvScalar color, int offsetX /*=0*/, int offsetY /*=0*/) const
    {
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    void CBlob_cuda::CopyEdges(CBlob_cuda &destination) const
    {
        CvSeqReader reader;
        CvSeqWriter writer;
        CvPoint edgeactual;
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    bool CBlob_cuda::GetConvexHull(CvSeq **dst) const
    {
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    CvBox2D CBlob_cuda::GetEllipse() const
    {
        CvBox2D elipse;
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetMoment::operator()(const CBlob_cuda &blob) const
    {
        //Moment 00
        if ((m_p == 0) && (m_q == 0))
            return blob.Area();
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetHullPerimeter::operator()(const CBlob_cuda &blob) const
    {
    ...
    double CBlobGetHullArea::operator()(const CBlob_cuda &blob) const
    {
        if (blob.Edges() != NULL && blob.Edges()->total > 0)
        {
            CvSeq *hull = cvConvexHull2(blob.Edges(), 0, CV_CLOCKWISE, 1);
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetMinXatMinY::operator()(const CBlob_cuda &blob) const
    {
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetMinYatMaxX::operator()(const CBlob_cuda &blob) const
    {
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetMaxXatMaxY::operator()(const CBlob_cuda &blob) const
    {
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetMaxYatMinX::operator()(const CBlob_cuda &blob) const
    {
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetElongation::operator()(const CBlob_cuda &blob) const
    {
        double ampladaC, longitudC, amplada, longitud;

        ampladaC = (double) (blob.Perimeter() + sqrt((blob.Perimeter() * blob.Perimeter()) - 16 * blob.Area())) / 4;
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetCompactness::operator()(const CBlob_cuda &blob) const
    {
        if (blob.Area() != 0.0)
            return (double) (blob.Perimeter() * blob.Perimeter()) / (4 * CV_PI * blob.Area());
        else
            return 0.0;
    }
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetRoughness::operator()(const CBlob_cuda &blob) const
    {
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetLength::operator()(const CBlob_cuda &blob) const
    {
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetBreadth::operator()(const CBlob_cuda &blob) const
    {
        double ampladaC, longitudC;
        double tmp;
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetDistanceFromPoint::operator()(const CBlob_cuda &blob) const
    {
    ...
    */
    ...
    - MODIFICATION: Date. Author. Description.
    */
    double CBlobGetXYInside::operator()(const CBlob_cuda &blob) const
    {
        if (blob.Edges() == NULL || blob.Edges()->total == 0) return 0.0;

        // passem els punts del blob a un vector de punts de les STL
        CvSeqReader reader;
        CBlob_cuda::vectorPunts vectorEdges;
        CBlob_cuda::vectorPunts::iterator itEdges, itEdgesSeguent;
        CvPoint edgeactual;
        bool dinsBlob;
        ...
        // ordenem el vector per les Y's i les X's d'esquerra a dreta
        std::sort(vectorEdges.begin(), vectorEdges.end(), CBlob_cuda::comparaCvPoint());
